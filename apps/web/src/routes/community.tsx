    ...
    <>
      <section className="relative overflow-hidden py-20 sm:py-28">
        ...
        <div className="relative z-10 mx-auto flex max-w-3xl flex-col items-center gap-6 px-6 text-center">
          ...
          <p className="text-lg leading-relaxed text-white/80 normal-case font-sans">
            The Christian journey was never meant to be walked alone. Isolation is one of the
            enemy's oldest weapons — a lone sheep is easy prey. Real church, real brotherhood, is a
            lifeline, not a club.
          </p>
        </div>
      </section>
      ...
      <GradientSection variant="cream">
        <SectionHeading
          ...
          description="Faith on Fire is for men ready to return, rebuild, and run their race."
        />
